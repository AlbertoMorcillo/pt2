            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form id="form">
                  ...
                  <div class="mb-3">
                    <input class="form-control" type="text" id="professor" name="professor" aria-label="Nom del professor responsable" placeholder="Professor">
                  </div>
                  <div class="mb-3">
                    <input class="form-control" type="file" id="fil" name="fil" aria-label="Imatge del taller" placeholder="img">
                  </div>
                  <div class="mb-3">
